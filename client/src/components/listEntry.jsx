    ...
    return (
      <div>
        <ReviewUsers>
          ...
          <FlagSvg viewBox="0 0 24 24" preservedAspectRatio>
        ...
        {textDisplay}
        <ReadMoreButton onClick={this.handleReadMore.bind(this)} > {!this.state.showMore ? 'Read more' : 'Read Less'} </ReadMoreButton>
